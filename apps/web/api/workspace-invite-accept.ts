...
import { acceptWorkspaceInvitationForAuthorizationHeader } from "../../../packages/workflow-service/src/index.js";
...
export default async function handler(request: VercelRequest, response: VercelResponse) {
  ...
  try {
    return response.status(200).json(
      await acceptWorkspaceInvitationForAuthorizationHeader(
